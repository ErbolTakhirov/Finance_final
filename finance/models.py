...
class Transaction(models.Model):
    ...
    Stores all financial transactions with proper validation
    """
    TYPE_CHOICES = [
        ('income', 'Доход'),
        ('expense', 'Расход'),
    ...
    amount = models.DecimalField(
        ...
        help_text='Amount (always positive, type determines if income or expense)'
    )
    type = models.CharField(max_length=10, choices=TYPE_CHOICES)
    category = models.CharField(max_length=100, help_text='Category (e.g., Зарплата, Еда, Аренда)')
    description = models.TextField(blank=True, help_text='Optional description')
    source = models.CharField(max_length=50, default='manual', help_text='Source of transaction (manual, imported, etc.)')
...
class MonthlySummary(models.Model):
    ...
    def recalculate(self):
        """
        Recalculate summary from transactions for this month
        """
